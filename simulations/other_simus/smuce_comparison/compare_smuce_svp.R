...
compare_smuce_svp <- function(
  ...
  ## SMUCE reports sqrt(2 T_i - 2 log(en/l)) <= q. The dedicated
  ## svp_smuce implementations below use the same q scale.
...
## Run explicitly with:
## source("simulations/other_simus/smuce_comparison/compare_smuce_svp.R")
