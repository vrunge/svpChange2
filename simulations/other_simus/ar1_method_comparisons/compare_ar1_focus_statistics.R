...
simulate_ar1_statistic_example <- function(n = 1000, tau = NULL, mu1 = 0, mu2 = 0,
                         rho = 0.7, sigma = 1) {
...
plot_statistic_panels <- function(seed = 10, n = 1000, rho = 0.7,
  ...
  set.seed(seed)
  scenarios <- list(
    no_change = simulate_ar1_statistic_example(n=n, rho=rho, sigma=sigma),
    weak_change = simulate_ar1_statistic_example(n=n, tau=n/2, mu2=1, rho=rho, sigma=sigma),
    strong_change = simulate_ar1_statistic_example(n=n, tau=n/2, mu2=3, rho=rho, sigma=sigma)
  )
